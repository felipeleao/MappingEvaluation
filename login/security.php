<?
  //The pages loading this script must include /config/constants.php
  ...
  */
  function validateUser($usuario, $senha) {
    ...
    $sql = "SELECT `id`, `user` FROM `".$_SG['tabela']."` WHERE ".$cS." `login` = '".$nusuario."' AND ".$cS." `password` = '".$nsenha."' LIMIT 1";
